...
DMP_CI_CONFIG_PARAMS='data.input.src.path=/daas/bstl/dpifix,/daas/whitelist/vendorasiainfo/dpi-whitelist#if.create.tables=false#is.output.these.tables=false'
