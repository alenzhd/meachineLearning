...
def delPath(path,iskeep01=True):
    flag = False
    ...
    if output_lines:
        ...
        for line in output_lines:
            ...
            if idx != -1 and len(line) >= idx + 15:
                ...
                if dayid <= date_1:
                    delCmd = "hdfs dfs -rm -r " + path + '/day_id='+dayid
                    print delCmd
                    if dayid[6:8] != '01' :
                        ...
                        if status == 0 :
                            ...
                            print "WARN!Do not del data of day 01."
                    else:
                        print "WARN!"
    # else:
...
#传递日期参数
    ...
    #处理dim_dmp_conf['DMP_CONF_IDC_TABLE_RETAIN_DAYS']
    tableNames=dim_dmp_conf['DMP_CONF_IDC_TABLE_RETAIN_DAYS'].split(';')
