...
#================================================================================
    ...
    hivesql.append('''
        ...
        join(
            select mix_uid, lower(if(flag='idfa',Md5UDF(flag_id),flag_id)) as dev_id, if(flag='idfa','idfa','imei') as id_type,province
            from %(source_tb_rel)s
            where day_id = %(ARG_OPTIME)s and flag in ('md532_imei', 'idfa')
        )tb2
        on (tb1.mix_uid = tb2.mix_uid and tb1.province = tb2.province)
